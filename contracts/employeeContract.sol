...
contract EmployeeManagement {
    ...
    constructor() {
        ...
        itBudget = (totalBalance * 60) / 100;
        businessDevBudget = (totalBalance - itBudget) / 2;
        operationsBudget = (totalBalance - itBudget) / 2;
    }
    ...
    function updatePerformance(uint256 _idx, uint256 _score) public {
        ...
        emit PerformanceScore(currEmployee.employeeAddress, _score);
    }
